# AI Hunter Daily — 2026-09-12

> 每日自动挖掘 GitHub 上新兴的 AI Agent / Skill / AI 工具项目。共发现 **15** 个候选项目。

## 📊 今日汇总

- 🏆 最高分项目：[duty1g/x64dbg-mcp-server](https://github.com/duty1g/x64dbg-mcp-server)（95.8 分）
- ⭐ 累计 Stars：1,088,931
- 🍴 累计 Forks：148,555

### 🔥 热门标签

`claude-code` (10), `claude` (8), `mcp` (8), `ai-agents` (6), `cursor` (6), `python` (6), `llm` (6), `agent` (5), `ai` (5), `anthropic` (5), `ai-agent` (5), `openai` (4), `developer-tools` (4), `agentic-ai` (3), `copilot` (3)
...
### 14. [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code)
...
*Generated by AI Hunter Daily at 2026-09-12T05:38*
